...
if os.path.basename(current_dir) == '_internal':
    abspath = os.path.dirname(current_dir) + '/'
else:
    abspath = current_dir + '/'
...
def infer_args():
    ...
    parser.add_argument("--rec_model_dir", type=str, default=abspath + 'resource/models/v4_rec.onnx')
    ...
    parser.add_argument(
        "--rec_char_dict_path",
        type=str,
        default=abspath + 'resource/models/ppocr_keys_v1.txt')
