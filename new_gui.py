...
class MainWindow(QMainWindowLog):
    ...
    def init_ui(self):
        ...
        self.Iron_blood_third_plane_pause_checkbox.setChecked(data.get("third_plane_pause_enabled", False))
    ...
    def save_ui_settings(self):
        ...
        data["third_plane_pause_enabled"] = self.Iron_blood_third_plane_pause_checkbox.isChecked()
